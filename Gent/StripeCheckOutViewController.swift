...
class StripeCheckOutViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let stripePublishableKey = "pk_test_pgAEdrRGRUZWZPzC8HmlcI1h"
    ...
    let backendBaseURL: String? = "https://mtteststripe.herokuapp.com/"
    ...
    init(product: String, price: Int, settings: Settings) {
        ...
        STPAPIClient.shared().baseURLString = self.backendBaseURL
    ...
    func paymentContext(_ paymentContext: STPPaymentContext, didCreatePaymentResult paymentResult: STPPaymentResult, completion: @escaping STPErrorBlock) {
        STPAPIClient.sharedClient.completeCharge(paymentResult,
